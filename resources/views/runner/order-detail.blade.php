...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="flex items-center justify-between gap-4 mb-8">
        <div>
            <p class="text-xs font-bold uppercase tracking-widest text-blue-600 mb-1">PESANAN</p>
    ...
    <div class="grid lg:grid-cols-[1fr_20rem] gap-6 items-start">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-3 sm:p-4">
                <div class="flex gap-4">
                    <div class="w-24 h-24 sm:w-28 sm:h-28 rounded-2xl bg-gray-100 overflow-hidden shrink-0">
                        <img src="{{ $item->watermark_url }}" alt="Foto pesanan"
                    ...
                    <div class="flex-1 min-w-0 flex flex-col justify-between">
                        ...
                        <div class="mt-3">
                            <a href="{{ route('download', $item->download_token, false) }}" class="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 text-white rounded-xl text-xs font-bold hover:bg-blue-700 transition">
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 lg:sticky lg:top-24">
            ...
            <div class="space-y-3 pb-4 border-b border-gray-100">
                ...
                <div class="flex items-center justify-between text-sm">
                    <span class="text-gray-500 font-semibold">Biaya layanan 15%</span>
            ...
            <div class="bg-green-50 border border-green-100 rounded-2xl p-4">
                <p class="text-xs font-bold text-green-700">Pembayaran terkonfirmasi. Berkas asli sudah dapat diunduh.</p>
                @if($order->paid_at)
            ...
            <div class="bg-red-50 border border-red-100 rounded-2xl p-4">
                <p class="text-xs font-bold text-red-600">Pesanan ini tidak dapat dibayar karena statusnya {{ strtolower($statusLabel) }}.</p>
            </div>
            @endif
