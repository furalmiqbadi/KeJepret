...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="text-center py-24">
        ...
        <p class="font-black text-gray-400 text-lg">Belum ada pesanan</p>
        <p class="text-gray-400 text-sm mt-1">Cari foto dan lakukan pemesanan untuk membuat pesanan pertama.</p>
