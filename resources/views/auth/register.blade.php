...
<body class="antialiased min-h-screen flex flex-col items-center justify-center py-12 px-6 relative select-none">
    ...
    <div class="w-full max-w-md space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 relative z-10">
        ...
        <div class="clean-glass p-10 rounded-[2.5rem] space-y-6 relative overflow-hidden">
            {{-- Modern Ambient Decorative Glow inside Card - Reduced to 2% opacity --}}
            <div class="absolute top-0 right-0 w-32 h-32 bg-sky-400/2 rounded-full blur-3xl pointer-events-none"></div>
            ...
            <form action="{{ route('register.post', [], false) }}" method="POST" class="space-y-5 relative z-10">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button" onclick="togglePassword('password_reg', 'eye_reg_open', 'eye_reg_close')"
                                ...
                                <svg id="eye_reg_close" class="w-5 h-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button" onclick="togglePassword('password_reg_confirm', 'eye_reg_confirm_open', 'eye_reg_confirm_close')"
                                ...
                                <svg id="eye_reg_confirm_close" class="w-5 h-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l18 18" />
                                </svg>
                            </button>
                        </div>
                ...
                {{-- Tombol Daftar Fotografer / Masuk rounded-full --}}
