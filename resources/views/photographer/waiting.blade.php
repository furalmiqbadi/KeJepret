...
<div class="max-w-lg mx-auto px-4 sm:px-6 py-16 flex flex-col items-center text-center">
    ...
    <span class="inline-block bg-green-50 text-green-600 text-[11px] font-black uppercase tracking-widest px-4 py-1.5 rounded-full border border-green-100 mb-4">Terverifikasi</span>
    <h1 class="text-3xl font-black text-gray-900 mb-3">Akun Diaktifkan!</h1>
    <p class="text-gray-500 text-sm leading-relaxed mb-8 max-w-sm">
        Selamat! Akun fotografer kamu sudah diverifikasi. Kamu sekarang bisa mulai upload foto event.
    </p>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400">Review selesai</p>
                </div>
            </div>
            <div class="flex items-center gap-3">
                <div class="w-7 h-7 bg-green-500 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <p class="text-sm font-bold text-gray-900">Akun Diaktifkan</p>
                    <p class="text-xs text-gray-400">Bisa upload foto event</p>
                </div>
            </div>
        </div>
    </div>

    <a href="{{ route('photographer.portfolio') }}" class="w-full max-w-xs py-3 bg-blue-600 text-white rounded-2xl font-bold text-sm hover:bg-blue-700 transition text-center block">
        Mulai Upload Foto
    </a>
    ...
    <div class="w-full max-w-sm bg-white rounded-2xl border border-gray-100 shadow-sm p-5 mb-8 text-left">
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center gap-3">
                <div class="w-7 h-7 bg-red-400 rounded-full flex items-center justify-center flex-shrink-0">
                ...
                <div>
                    <p class="text-sm font-bold text-gray-900">Ditinjau Admin</p>
                    <p class="text-xs text-gray-400">Pendaftaran tidak disetujui</p>
                </div>
            </div>
            <div class="flex items-center gap-3">
