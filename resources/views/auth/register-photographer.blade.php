...
<body class="antialiased min-h-screen flex items-center justify-center py-12 px-6 relative select-none">
    ...
    <div class="w-full max-w-lg space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-1000 relative z-10">

        {{-- Info Box (Frosted Glass Light - Clean Glass Box) --}}
        <div class="flex items-start gap-3 clean-glass-box rounded-2xl px-5 py-4 shadow-sm shadow-slate-200/50">
            <span class="material-symbols-outlined text-[20px] mt-0.5 shrink-0 text-sky-700">info</span>
            <p class="text-xs font-bold leading-relaxed text-slate-600">
                Akun fotografer memerlukan verifikasi admin. Pengunggahan KTP diperlukan untuk proses verifikasi sebelum Anda dapat mengunggah foto.
            </p>
        </div>
            ...
            <form action="{{ route('register.photographer.post') }}" method="POST" enctype="multipart/form-data" class="space-y-5 relative z-10">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button" onclick="togglePassword('password_foto', 'eye_foto')"
                                ...
                                <span class="material-symbols-outlined text-[18px]" id="eye_foto">visibility</span>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button" onclick="togglePassword('password_foto_confirm', 'eye_foto_confirm')"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-sky-700 hover:text-sky-900 transition-colors">
                                <span class="material-symbols-outlined text-[18px]" id="eye_foto_confirm">visibility</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="clean-glass-box rounded-2xl p-5 transition-all shadow-sm shadow-slate-200/50 space-y-4">
                        ...
                        {{-- Preview Area --}}
                        <div id="ktp_preview_container" class="relative w-full h-40 rounded-xl border border-dashed border-slate-300 bg-white/30 flex flex-col items-center justify-center overflow-hidden group/preview transition-all">
                            <img id="ktp_preview_image" src="" alt="Pratinjau KTP" class="hidden w-full h-full object-cover">
                            <div id="ktp_placeholder" class="flex flex-col items-center gap-1.5 text-slate-400 text-center px-4">
                                <span class="material-symbols-outlined text-[36px] text-sky-700 group-hover/preview:scale-110 transition-transform">badge</span>
                                <p class="text-[10px] font-black uppercase tracking-wider text-slate-500">Belum Ada Berkas Terpilih</p>
                                <p class="text-[9px] font-semibold text-slate-400/70">Pratinjau KTP Anda akan muncul di sini</p>
                            </div>
                        </div>
